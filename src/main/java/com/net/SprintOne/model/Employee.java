...
public class Employee implements Serializable {
    ...
    public Employee(String full_name, String address, String department, String gender, String job_title, String place_of_birth, String race, String religion, Date birth_day, Date contracted_date, Date start_date, int cell_phone, Employee manager_id, Set<Employee> subordinates, User user) {
        this.full_name = full_name;
        this.address = address;
        this.department = department;
        this.gender = gender;
